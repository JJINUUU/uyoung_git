...
public class MainActivity<view> extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if (view == dateBtn) {
            ...
            View customDialogView = inflater.inflate(R.layout.add_dialog_layout, null);
            ...
            new SimpleSearchDialogCompat(MainActivity.this, "팀원 찾기", "이름을 입력하세요",
            ...
            // custom dialog를 위한 layout xml 초기화
            LayoutInflater inflater = (LayoutInflater) getSystemService(LAYOUT_INFLATER_SERVICE);
            View customDialogView = inflater.inflate(R.layout.set_dialog_layout, null);
            builder.setView(customDialogView);
            builder.setPositiveButton("확인", dialogListener);
            builder.setNegativeButton("취소", null);
